...
public class SmsUtils {
	...
	private static IAcsClient initClient() throws com.aliyuncs.exceptions.ClientException {
	    ...
	    // 秘钥key和secret
	    final String appkey = "LTAIHEfIhiTbnFku";
	    final String appSecret = "gbtRBRzuL1L9pmJQfDgguYMY9SMXVE";
	...
	private static SendSmsRequest getVerifyCode(String phoneNumber,String code) {
	     ...
	     //必填:短信签名-可在短信控制台中找到
	     request.setSignName("火眼");
	     //必填:短信模板-可在短信控制台中找到
	     request.setTemplateCode("SMS_126460392");
